...
const BlogContent = observer(() => {
  ...
  useEffect(() => {
    ...
    let cards = JSON.parse(JSON.stringify(content.posts));

    if (cat.length) {
      cards = cards.filter(
        (p: any) => p.cat.toLocaleLowerCase() === cat.toLocaleLowerCase()
      );
    }
        ...
        <div className="blog-content__container" ref={ref}>
          ...
          <div className="blog-content__row">
            ...
            >
              ...
              <div className="blog-content__aside-list ">
                {DBStore.locations && JSON
                  .parse(JSON.stringify(DBStore.locations))
