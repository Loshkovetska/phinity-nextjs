...
const VideoIntro = observer(({ videoCont }: { videoCont: any }) => {
  ...
  if (links) {
    ...
    locations = links.find((l: any) => l.id == 5083).link;
  }
  ...
  return (
    <section className="video-intro">
      ...
      <div className="video-intro__container">
        ...
        <div className="video-intro__content">
          ...
          <div className="video-intro__top">
            ...
            <div className="video-intro__right">
              ...
              <div className="blog-content__aside-book">
                <h3
                  dangerouslySetInnerHTML={{
                    __html: content?.book?.title,
                  }}
                ></h3>
                <p
                  dangerouslySetInnerHTML={{
                    __html: content?.book?.text,
                  }}
                ></p>
                <a
                  className="button light-blue"
                  href={content.book.buttonLink}
                  target="_blank"
                  rel="noreferrer"
                >
                  <div className="button__text">{content.book.buttonText}</div>
                </a>
              </div>
            </div>
          </div>
      ...
      <div className={classNames("post-content__aside", showFilter && "show")}>
        <Close
